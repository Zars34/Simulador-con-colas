...
namespace WinFormsApp1
{
    public partial class Form3 : Form
    {
        ...
        public Form3(int cant_autos1, int cant_minutos1, int cant_autos2, int cant_minutos2, int espera_auto, int costo_auto, int precio_vagon, int precio_auto, int cant_minutos_viaje, int cant_minutos_viaje_vacio
            , int cant_minutos_simulacion)
        {
            InitializeComponent();
        ...
        public void FuncionCiclica(Fila fila)
        {
            ...
            if (fila.Reloj <= cant_minutos_simulacion)
            {
                ...
                if (cant_minutos_simulacion < prox_tiempo)
                {
                    ...
                    prox_tiempo = cant_minutos_simulacion;
                }
        ...
        public void GenerarFinParada(Fila fila, int parada_destino)
        {
            if (parada_destino == 1)
            {
                ...
                if(fila.Vagon.Lista_autos.Count != 0)
                {
                ...
                {
                    fila.Fin_parada.Prox_tiempo = fila.Reloj + fila.Fin_parada.Cant_minutos_viaje_vacio;
                    fila.Fin_parada.Parada_destino = parada_destino;
                }
            }
            else
